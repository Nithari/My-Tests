...
public class DragAndDropDemo extends base {
	...
	public static void main(String[] args) throws MalformedURLException {
		...
		t.longPress(longPressOptions().withElement(element(source))).moveTo(element(destination)).release().perform();//either write like this
		t.longPress(element(source)).moveTo(element(destination)).release().perform();//or shortcut like this
	}
